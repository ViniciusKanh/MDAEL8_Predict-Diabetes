...
for i in range(len(classifiers)):
    ...
    print(tabulate(confusion_matrices[i], headers=range(2), tablefmt="grid"))
...
for rect1, rect2, rect3 in zip(rects1, rects2, rects3):
    ...
    ax.annotate(f'Acurácia: {round(height1, 2)}', xy=(rect1.get_x() + rect1.get_width() / 2, height1),
                xytext=(0, 3), textcoords="offset points",
                ha='center', va='bottom')
    ax.annotate(f'F1-Score: {round(height2, 2)}', xy=(rect2.get_x() + rect2.get_width() / 2, height2),
                xytext=(0, 3), textcoords="offset points",
                ha='center', va='bottom')
    ax.annotate(f'Precision: {round(height3, 2)}', xy=(rect3.get_x() + rect3.get_width() / 2, height3),
                xytext=(0, 3), textcoords="offset points",
                ha='center', va='bottom')
